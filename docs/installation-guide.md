...
| `SPRING_DATASOURCE_HIKARI_MAX_LIFETIME`                | No        | 7200000                                                                                                        | Spring hikari max-lifetime value (0 is default, means "infinite") |
| `SPRING_DATASOURCE_HIKARI_IDLE_TIMEOUT`                | No        | 180000                                                                                                         | Spring hikari idle-timeout value (180000 is default)              |
| `SPRING_DATASOURCE_HIKARI_KEEPALIVE_TIME`              | No        | 55000                                                                                                          | Spring hikari keepalive time value (55000 is default)             |
| `SPRING_DATASOURCE_HIKARI_CONNECTION_TIMEOUT`          | No        | 25000                                                                                                          | Spring hikari connection timeout value (25000 is default)         |
