...
public interface IEventTriggerSwitcher {
    ...
    void activate(EventTrigger eventTrigger) throws TriggerException;

    void deactivate(EventTrigger trigger) throws TriggerException;

    void apply(EventTrigger eventTrigger) throws TriggerException;
