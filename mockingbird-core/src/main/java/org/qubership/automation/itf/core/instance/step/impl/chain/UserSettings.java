...
public class UserSettings extends AbstractChainUnit {

    @Override
    public boolean isAcceptable(PropertyDescriptor descriptor) {
        return descriptor.userSettings();
    }
    ...
    public void accept(PropertyDescriptor descriptor, Message message, InstanceContext context) {
        ...
        message.setText(TemplateProcessor.getInstance().process(null, message.getText(), context,
