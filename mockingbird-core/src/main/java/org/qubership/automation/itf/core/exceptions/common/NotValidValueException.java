...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "ITFEXE-2002")
public class NotValidValueException extends ItfExecutorException {

    public static final String DEFAULT_MESSAGE = "Not valid value. %s";
