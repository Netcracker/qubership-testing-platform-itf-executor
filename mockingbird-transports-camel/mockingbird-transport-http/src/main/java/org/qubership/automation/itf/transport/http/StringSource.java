 ...
 * is default UTF-8.
 * Copied from Apache Camel 2.20.4 camel-core/org/apache/camel/StringSource since it's not available in
 * modern Camel versions. Further refactoring would avoid its usage.
 */
