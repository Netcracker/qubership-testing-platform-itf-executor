...
/*        putSafe(env, Context.INITIAL_CONTEXT_FACTORY, "com.sun.jndi.fscontext.RefFSContextFactory");
        putSafe(env, Context.SECURITY_PRINCIPAL, "");
        putSafe(env, Context.SECURITY_CREDENTIALS, "");
        ...
        String[] providers = Reflection.toArray(String.class, "t3://some-provider-service-address:9876");
