...
public class RARInterceptor extends ExternalInterceptor {

    public RARInterceptor() {
        setType(RAR);
    }

    public RARInterceptor(Object transportId, Object tcContextId) {
        super(transportId, tcContextId, RAR);
    }

    @Override
    boolean isApplicable(String message) {
        return Helper.checkRequestTagAndSession(message, "<RAR>", getSessionId());
    }
    ...
    public boolean equals(Object o) {
        ...
        RARInterceptor that = (RARInterceptor) o;
