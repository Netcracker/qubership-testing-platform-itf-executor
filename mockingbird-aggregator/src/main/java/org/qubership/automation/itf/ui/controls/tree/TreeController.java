...
public interface TreeController {
    ...
    UITreeData getTree(@RequestParam(required = false) String id,
                       @RequestParam(value = "projectUuid") UUID projectUuid);

    UITreeData getTreeFromNode(@RequestParam(required = false) String id,
                               @RequestParam(required = false) String parentId,
                               @RequestParam(value = "projectUuid") UUID projectUuid);

    UITreeData getTreeFromNodeByName(@RequestParam(required = false) String value,
