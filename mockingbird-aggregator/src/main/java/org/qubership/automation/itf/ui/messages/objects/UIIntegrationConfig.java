...
public class UIIntegrationConfig extends UIConfiguration {

    public UIIntegrationConfig() {
    }

    public UIIntegrationConfig(IntegrationConfig integrationConfig) {
        super(integrationConfig);
        setUserTypeName(integrationConfig.getTypeName());
