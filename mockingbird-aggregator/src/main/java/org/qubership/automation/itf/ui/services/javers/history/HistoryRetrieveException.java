...
public class HistoryRetrieveException extends AtpException {

    public static final String DEFAULT_MESSAGE = "Error occurred when tried to retrieve object %s%s%s";
    ...
    public HistoryRetrieveException(String errorMessage) {
        this(errorMessage, null, null);
    }

    public HistoryRetrieveException(String errorMessage, String id, String type) {
