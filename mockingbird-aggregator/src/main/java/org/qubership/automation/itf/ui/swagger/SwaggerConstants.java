...
public interface SwaggerConstants {
    ...
    String INTERNAL_API_DESCR = "Internal API description. Expected to be used through UI, can be called through "
            + "REST, but correct behavior is not guaranteed.";
    ...
    String BULK_INTEGRATION_API_DESCR = "Bulk Validator Integration API description. Used through UI, can be called "
            + "through REST.";
    ...
    String ENVIRONMENT_TRIGGER_QUERY_API_DESCR = "Environment trigger API to query environment trigger. Called "
            + "through REST.";
    String ENVIRONMENT_TRIGGER_COMMAND_API = "Environment trigger commands API.";
    String ENVIRONMENT_TRIGGER_COMMAND_API_DESCR = "Environment trigger API to control environment trigger. Called "
            + "through REST.";

    String SERVER_CONFIGURATION_QUERY_API = "Server configuration queries API.";
    String SERVER_CONFIGURATION_QUERY_API_DESCR = "Server configuration API to query server configuration. Called "
            + "through REST.";
    String SERVER_CONFIGURATION_COMMAND_API = "Server configuration commands API.";
    String SERVER_CONFIGURATION_COMMAND_API_DESCR = "Server configuration API to control server configuration. Called"
            + " through REST.";
    ...
    String TOKEN_GENERATOR_COMMAND_API_DESCR = "Service used for generating authentication tokens by provided "
            + "user-password pair.";
}
