...
COPY build-context/qubership-testing-platform-itf-executor/qubership-testing-platform-itf-executor/common/target/ /tmp/
...
RUN unzip /tmp/*.zip -d $HOME_EX/ && \
    ...
    rm -rf $HOME_EX/lib/mockingbird-aggregator-*-sources.jar && \
