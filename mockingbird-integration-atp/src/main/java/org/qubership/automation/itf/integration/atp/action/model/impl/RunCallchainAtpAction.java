...
public class RunCallchainAtpAction extends AbstractAtpAction {

    public RunCallchainAtpAction() {
        super(ATPActionConstants.RUN_ITF_CASE_BY_NAME_NAME.stringValue(),
                ATPActionConstants.RUN_ITF_CASE_BY_NAME_DESCRIPTION.stringValue(),
                ATPActionConstants.RUN_ITF_CASE_BY_NAME_MASK.stringValue(),
                ATPActionConstants.RUN_ITF_CASE_BY_NAME_TEMPLATE.stringValue());
    }

    public RunCallchainAtpAction(String name, String description, String mask, String template) {
