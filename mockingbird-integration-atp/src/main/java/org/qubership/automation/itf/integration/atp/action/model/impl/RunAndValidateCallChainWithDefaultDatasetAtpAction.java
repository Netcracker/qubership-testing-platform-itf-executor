...
public class RunAndValidateCallChainWithDefaultDatasetAtpAction extends RunCallChainWithDefaultDatasetAtpAction {

    public RunAndValidateCallChainWithDefaultDatasetAtpAction() {
        super(ATPActionConstants.RUN_AND_VALIDATE_ITF_CASE_BY_NAME_WITH_DEFAULT_DATASET_NAME.stringValue(),
                ATPActionConstants.RUN_AND_VALIDATE_ITF_CASE_BY_NAME_WITH_DEFAULT_DATASET_DESCRIPTION.stringValue(),
                ATPActionConstants.RUN_AND_VALIDATE_ITF_CASE_BY_NAME_WITH_DEFAULT_DATASET_MASK.stringValue(),
                ATPActionConstants.RUN_AND_VALIDATE_ITF_CASE_BY_NAME_WITH_DEFAULT_DATASET_TEMPLATE.stringValue());
    }

    @SuppressWarnings("unused")
    RunAndValidateCallChainWithDefaultDatasetAtpAction(String name, String description, String mask, String template) {
