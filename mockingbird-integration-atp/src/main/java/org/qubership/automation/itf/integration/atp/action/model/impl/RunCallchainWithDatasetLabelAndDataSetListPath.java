...
public class RunCallchainWithDatasetLabelAndDataSetListPath extends AbstractAtpAction {

    public RunCallchainWithDatasetLabelAndDataSetListPath() {
        super(ATPActionConstants.RUN_ITF_CASE_BY_NAME_WITH_DATASET_LABEL_AND_DATASETLIST_PATH_NAME.stringValue(),
                ATPActionConstants.RUN_ITF_CASE_BY_NAME_WITH_DATASET_LABEL_AND_DATASETLIST_PATH_DESCRIPTION
                        .stringValue(),
                ATPActionConstants.RUN_ITF_CASE_BY_NAME_WITH_DATASET_LABEL_AND_DATASETLIST_PATH_MASK.stringValue(),
                ATPActionConstants.RUN_ITF_CASE_BY_NAME_WITH_DATASET_LABEL_AND_DATASETLIST_PATH_TEMPLATE.stringValue());
    }
