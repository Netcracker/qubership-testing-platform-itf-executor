...
public abstract class RunCallchainsByLabel extends AbstractAtpAction {
    RunCallchainsByLabel(String name, String description, String mask, String template) {
        super(name, description, mask, template);
    }

    @Override
    public List<ArgumentValue> getAvailableValues(BigInteger projectId) {
        return Lists.newArrayList(DefinitionBuilder.getAvailableCallchainLabelList());
    }
}
