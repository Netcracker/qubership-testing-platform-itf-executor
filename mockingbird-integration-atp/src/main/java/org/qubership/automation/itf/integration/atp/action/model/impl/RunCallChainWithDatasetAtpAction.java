...
public class RunCallChainWithDatasetAtpAction extends AbstractAtpAction {

    public RunCallChainWithDatasetAtpAction() {
        super(ATPActionConstants.RUN_ITF_CASE_BY_NAME_WITH_DATASET_NAME.stringValue(),
                ATPActionConstants.RUN_ITF_CASE_BY_NAME_WITH_DATASET_DESCRIPTION.stringValue(),
                ATPActionConstants.RUN_ITF_CASE_BY_NAME_WITH_DATASET_MASK.stringValue(),
                ATPActionConstants.RUN_ITF_CASE_BY_NAME_WITH_DATASET_TEMPLATE.stringValue());
    }

    RunCallChainWithDatasetAtpAction(String name, String description, String mask, String template) {
    ...
    public List<ArgumentValue> getAvailableValues(BigInteger projectId) {
        return Lists.newArrayList(DefinitionBuilder.getAvailableCallchainsList(projectId),
                DefinitionBuilder.getAvailableDatasetsEmptyList());
    }
